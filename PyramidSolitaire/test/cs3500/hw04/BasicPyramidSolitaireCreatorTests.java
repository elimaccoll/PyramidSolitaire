...
/**
 * Test Class for BasicPyramidSolitaire created with PyramidSolitaireCreator.
 */
public class BasicPyramidSolitaireCreatorTests {

  // BasicPyramidSolitaire factory tests
  @Test
  public void testCreateBasicPyramidSolitaire() {
    assertEquals(new BasicPyramidSolitaire(),
        PyramidSolitaireCreator.create(GameType.BASIC));
  }

  PyramidSolitaireModel model = PyramidSolitaireCreator.create(GameType.BASIC);
